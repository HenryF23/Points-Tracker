...
import com.example.a3dscannerapp.fio.CustomCompressor;
import com.example.a3dscannerapp.fio.CustomFileWriter;
import com.example.a3dscannerapp.fio.CustomStreamWriterManager;
import com.example.a3dscannerapp.helpers.PermissionHelper;
import com.example.a3dscannerapp.helpers.DepthTextureHandler;
import com.example.a3dscannerapp.helpers.DisplayRotationHelper;
import com.example.a3dscannerapp.helpers.SnackbarHelper;
import com.example.a3dscannerapp.helpers.TrackingStateHelper;
import com.example.a3dscannerapp.model.CameraFrameInfo;
import com.example.a3dscannerapp.model.CameraInfo;
import com.example.a3dscannerapp.rendering.BackgroundRenderer;
import com.example.a3dscannerapp.rendering.ObjectRenderer;
...
/**
 * ARCore activity that let user record the rgb frames, depth frames and depth confidence maps using ARCore
 */
...
//                customStreamWriterManager.writeToFile(fileName + ".confidence.zlib", depthConfidenceByteBuffer);
    ...
    private void updateCameraInfo(Frame frame, Camera camera) {
        cameraInfo.imageDimensions = camera.getImageIntrinsics().getImageDimensions();
